...
<!-- [ breadcrumb ] end -->
<!-- [ Main Content ] start -->
<div class="row Tentor-isi">
  <!-- [ static-layout ] start -->
  <div class="col-sm-12">
    <div class="card">
      <div class="card-header text-center">
        <h3 class="text-primary"><strong>Tentor</strong></h3>
      </div>
      <div class="card-body">
        <div class="float-right mb-3">
          <button type="button" class="btn btn-primary has-ripple" id="TentorAdd"><i class="feather mr-2 icon-plus"></i>Tambah Data<span class="ripple ripple-animate" style="height: 112.65px; width: 112.65px; animation-duration: 0.7s; animation-timing-function: linear; background: rgb(255, 255, 255) none repeat scroll 0% 0%; opacity: 0.4; top: -38.825px; left: -2.85833px;"></span></button>
  ...
  <div class="modal-dialog modal-xl">
    <div class="modal-content">
      ...
      <div class="modal-header">
        <h4 class="modal-title judul">Tentor</h4>
      ...
      <div class="modal-body">
        ...
        <form id="submitForm">
          <div class="form-group fill">
            <input type="hidden" name="id_Tentor" id="id">
...
<script>
  $(document).ready(function() {
    const site_url = "<?= site_url('Tentor/'); ?>";
    $('.Tentor-isi').on('click', '#TentorAdd', function() {
      $('.judul').html('Tambah Tentor');
    ...
    $('.Tentor-isi').on('click', '.update', function() {
      $('.judul').html('Update Tentor');
    ...
    $('.Tentor-isi').on('click', '.delete', function() {
      let id = $(this).attr('value');

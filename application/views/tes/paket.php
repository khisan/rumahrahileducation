        ...
        <div class="row align-items-center">
            <div class="col-md-12">
                ...
                <ul class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="<?= site_url("latihan/index/$latihan->bab_id"); ?>"><?= $bab->nama_bab; ?></a></li>
                    <li class="breadcrumb-item"><a href="#!"><?= $latihan->nama_latihan; ?></a></li>
                </ul>
            </div>
        </div>
    </div>
    ...
    <div class="col-sm-12">
        <div class="card">
            <div class="card-header text-center">
                <h3 class="text-primary"><strong>Paket : <?= $latihan->nama_latihan; ?></strong></h3>
            </div>
            <div class="card-body">
                <div class="row mb-3">
                    <div class="col-sm-5">
                        <h1><?= $latihan->nama_latihan; ?></h1>
                    </div>
                    <div class="offset-sm-6 col-sm-1">
                        <div class="float-right">
                            <a href="<?= site_url("latihan/index/$latihan->bab_id"); ?>" class="btn btn-warning btn-flat">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form id="submitForm">
                    ...
                    <input type="hidden" name="latihan_id" id="latihan" value="<?= $latihan->id_latihan; ?>">
...
<script>
    $(document).ready(function() {
        ...
        $('.paket-isi').on('click', '.update', function() {
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    $('#latihan').val(response.latihan_id);
        ...
        let table = $('#table').DataTable({
            ...
            serverSide: true,
            ajax: {
                url: '<?= site_url('paket/getAjax/') . $latihan->id_latihan; ?>',
                type: 'POST'
            },
            columnDefs: [{
                    targets: [-1],

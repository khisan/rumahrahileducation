...
class MapelGuru extends CI_Controller
{
  ...
  public function __construct()
  {
    parent::__construct();
    check_not_login();
    $this->load->model('MapelGuru_model', 'mapel');
    $this->load->model('Guru_model', 'guru');
    $this->load->model('Kelas_model', 'kelas');
    $this->load->model('Mapel_model', 'mapel_soal');
  }
  ...
  public function get($id = null)
  {
    ...
    $data['mapel'] = $this->mapel_soal->get()->result();
  ...
  public function getAjax($id = null)
  {
    ...
    foreach ($list as $mapel) {
      ...
      $row[] = $mapel->nama_kelas;
      $row[] = $mapel->sekolah;
      $row[] = $mapel->keterangan;
      $row[] = $mapel->created;
      $row[] = $mapel->updated;
      $row[] = '
